...
if ($_GET['paso']==1){
	...
	echo "<b>Nota</b>: Estos ficheros de configuración estan creados con el formato YAML, modificar un simple espacio destrozaria la configuración. <br>Por eso se recomienda tan solo modificar lo necesario y respetar la estructura.<br>";
...
if ($_GET['paso']==5){
	...
	echo "Para dar salida al proyecto a los usuarios. <b>Tienes que editar el fichero tú.</b>
	<br><br> Ejemplo:<br> 
<pre>
